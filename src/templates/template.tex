...
\begin{enumerate}
\item Routing, controllers, and actions
\item Manipulating requests and response
\item Generating HTML
\item Parsing and validating forms
\item Reading and writing JSON
\item Asynchronous requesting handling
\item Calling external web services
\end{enumerate}
