...
// halSays: slick.lifted.Query[MessageTable,MessageTable#TableElementType,Seq] = Rep(Filter @1874810481)
```
...
// db: slick.driver.H2Driver.backend.Database = slick.jdbc.JdbcBackend$DatabaseDef@1c6df32c
```
...
// res0: List[String] = List(create table "message" ("sender" VARCHAR NOT NULL,"content" VARCHAR NOT NULL,"id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY))
```
...
// action: slick.driver.H2Driver.api.DBIO[Unit] = slick.driver.JdbcActionComponent$SchemaActionExtensionMethodsImpl$$anon$5@1f99bcdf
```
...
// future: scala.concurrent.Future[Unit] = scala.concurrent.impl.Promise$DefaultPromise@7bf5851f
```
...
// insert: slick.driver.H2Driver.api.DBIO[Option[Int]] = slick.driver.JdbcActionComponent$InsertActionComposerImpl$MultiInsertAction@15d81f7d
```
...
// result: scala.concurrent.Future[Option[Int]] = scala.concurrent.impl.Promise$DefaultPromise@6190e3eb
```
...
// messagesAction: slick.driver.H2Driver.api.DBIO[Seq[Message]] = slick.driver.JdbcActionComponent$QueryActionExtensionMethodsImpl$$anon$1@29de5cd7

val messagesFuture: Future[Seq[Message]] = db.run(messagesAction)
// messagesFuture: scala.concurrent.Future[Seq[Message]] = scala.concurrent.impl.Promise$DefaultPromise@145484bd
...
// exec: [T](action: slick.driver.H2Driver.api.DBIO[T])T
```
...
// res6: Iterable[String] = List(select "id" from "message" where "sender" = 'HAL')
...
// actions: slick.driver.H2Driver.api.DBIO[Seq[Message]] = slick.dbio.SynchronousDatabaseAction$FusedAndThenAction@2290ed59
```
...
// sameActions: slick.dbio.DBIOAction[Seq[MessageTable#TableElementType],slick.dbio.Streaming[MessageTable#TableElementType],slick.dbio.Effect.Schema with slick.dbio.Effect.Write with slick.dbio.Effect.Read] = slick.dbio.SynchronousDatabaseAction$FusedAndThenAction@92059cc
```
